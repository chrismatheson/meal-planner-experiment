...
- [x] Protein variety (max 2 same protein per week, soft constraint)

#### P1 - Should Have (Deferred to v2.1)
...
- ProteinDetector: Ingredient keyword matching + name/category fallback
